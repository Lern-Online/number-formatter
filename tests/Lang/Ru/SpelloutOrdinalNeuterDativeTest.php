...
class SpelloutOrdinalNeuterDativeTest extends \PHPUnit_Framework_TestCase
{
    protected $formatter;
    ...
    protected function setUp()
    {
        ...
        $this->formatter->setTextAttribute(NumberFormatter::DEFAULT_RULESET, "%spellout-ordinal-neuter-dative");

        $this->masculineFormatter = new NumberFormatter('ru', NumberFormatter::SPELLOUT);
        $this->masculineFormatter->setTextAttribute(NumberFormatter::DEFAULT_RULESET, "%spellout-masculine-dative");
    }
