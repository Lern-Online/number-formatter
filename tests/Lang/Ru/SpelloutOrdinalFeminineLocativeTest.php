...
class SpelloutOrdinalFeminineLocativeTest extends \PHPUnit_Framework_TestCase
{
    protected $formatter;
    ...
    protected function setUp()
    {
        ...
        $this->formatter->setTextAttribute(NumberFormatter::DEFAULT_RULESET, "%spellout-ordinal-feminine-locative");
