...
class SpelloutOrdinalPluralAccusativeTest extends \PHPUnit_Framework_TestCase
{
    protected $formatter;
    ...
    protected function setUp()
    {
        ...
        $this->formatter->setTextAttribute(NumberFormatter::DEFAULT_RULESET, "%spellout-ordinal-plural-accusative");

        $this->pluralFormatter = new NumberFormatter('ru', NumberFormatter::SPELLOUT);
        $this->pluralFormatter->setTextAttribute(NumberFormatter::DEFAULT_RULESET, "%spellout-ordinal-plural");
    }
